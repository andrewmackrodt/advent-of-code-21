...
exports.partTwo = exports.partOne = exports.getStepFlashesSynchronized = exports.getTotalFlashes = void 0;
...
function getTotalFlashes(input, steps) {
...
exports.getTotalFlashes = getTotalFlashes;
function getStepFlashesSynchronized(input) {
    const map = input.split('\n').map(line => line.split('').map(char => parseInt(char, 10)));
...
exports.getStepFlashesSynchronized = getStepFlashesSynchronized;
//region internal
const partOne = (input) => getTotalFlashes(input, 100);
exports.partOne = partOne;
const partTwo = (input) => getStepFlashesSynchronized(input);
