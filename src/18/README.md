...
Pairs are written as [x,y], where x and y are the elements within the pair. Here are some example snailfish numbers, one
...
Exploding pairs will always consist of two regular numbers. Then, the entire exploding pair is replaced with the regular
number 0.
...
- [[3,[2,[1,[7,3]]]],[6,[5,[4,[3,2]]]]] becomes [[3,[2,[8,0]]],[9,[5,[4,[3,2]]]]] (the pair [3,2] is unaffected because
...
For example, the magnitude of [9,1] is 3\*9 + 2\*1 = 29; the magnitude of [1,9] is 3\*1 + 2\*9 = 21. Magnitude calculations
are recursive: the magnitude of [[9,1],[1,9]] is 3\*29 + 2\*21 = 129.
