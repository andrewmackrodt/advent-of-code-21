...
exports.partTwo = exports.partOne = exports.splitBound = void 0;
...
function parseInput(input) {
    return input.trim().split('\n')
        ...
        .map((line, i) => {
        var _a;
        const operation = (_a = line.match(/^(on|off) /)) === null || _a === void 0 ? void 0 : _a[1];
        if (!operation)
...
//region internal
const partOne = (input) => solve(input, { min: -50, max: 50 });
exports.partOne = partOne;
const partTwo = (input) => solve(input);
