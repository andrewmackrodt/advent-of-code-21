...
exports.partTwo = exports.partOne = exports.getLargestMagnitudeOf2 = exports.getMagnitudeOfFinalSum = exports.SnailfishUtils = exports.Tree = void 0;
const fs_1 = require("fs");
const isValueNode = (branch) => {
    return 'value' in branch;
};
const isLeft = (node) => { var _a; return ((_a = node.parent) === null || _a === void 0 ? void 0 : _a.left) === node; };
const isRight = (node) => { var _a; return ((_a = node.parent) === null || _a === void 0 ? void 0 : _a.right) === node; };
class Tree {
        ...
        if (isRight(this)) {
            if (isValueNode(this.parent.left)) {
                ...
                const findFirstRightValue = (node) => {
                    var _a;
                    return (_a = (isValueNode(node.right) ? node.right : undefined)) !== null && _a !== void 0 ? _a : findFirstRightValue(node.right);
        ...
        if (isLeft(this)) {
            if (isValueNode(this.parent.right)) {
                ...
                const findFirstLeftValue = (node) => {
                    var _a;
                    return (_a = (isValueNode(node.left) ? node.left : undefined)) !== null && _a !== void 0 ? _a : findFirstLeftValue(node.left);
...
exports.SnailfishUtils = SnailfishUtils;
function getMagnitudeOfFinalSum(input) {
...
exports.getMagnitudeOfFinalSum = getMagnitudeOfFinalSum;
function getLargestMagnitudeOf2(input) {
...
exports.getLargestMagnitudeOf2 = getLargestMagnitudeOf2;
//region internal
const partOne = (input) => getMagnitudeOfFinalSum(input);
exports.partOne = partOne;
const partTwo = (input) => getLargestMagnitudeOf2(input);
