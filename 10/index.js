...
exports.partTwo = exports.partOne = exports.getMiddleAutocompleteScore = exports.getErrorScore = void 0;
    ...
    for (const line of input.split('\n')) {
        ...
        for (const c of line) {
            ...
            if (chunk.type === 'open') {
                ...
                if (chunk.value !== (expected === null || expected === void 0 ? void 0 : expected.inverse)) {
                    score = errorPoints[c];
                    break;
                }
                else {
...
exports.getErrorScore = getErrorScore;
function getMiddleAutocompleteScore(input) {
...
exports.getMiddleAutocompleteScore = getMiddleAutocompleteScore;
//region internal
const partOne = (input) => getErrorScore(input);
exports.partOne = partOne;
const partTwo = (input) => getMiddleAutocompleteScore(input);
