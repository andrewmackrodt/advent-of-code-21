...
exports.partTwo = exports.partOne = exports.sumOutputs = exports.countOccurrences = void 0;
const fs_1 = require("fs");
function countOccurrences(input, digits) {
    return input.split('\n').reduce((total, entry) => (total + entry.split(' | ')[1]
        .split(' ')
        .filter(o => digits.includes(o.length)).length), 0);
}
exports.countOccurrences = countOccurrences;
function sumOutputs(input) {
    let result = 0;
...
exports.sumOutputs = sumOutputs;
//region internal
const partOne = (input) => countOccurrences(input, [2, 3, 4, 7]);
exports.partOne = partOne;
const partTwo = (input) => sumOutputs(input);
