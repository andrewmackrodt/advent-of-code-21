...
exports.partTwo = exports.partOne = exports.getLargestManhattanDistance = exports.countBeacons = exports.mergeScannerReports = void 0;
...
function mergeScannerReports(input) {
    var _a;
    ...
    (_a = report.shift()) === null || _a === void 0 ? void 0 : _a.forEach(b => {
...
exports.mergeScannerReports = mergeScannerReports;
function countBeacons(input) {
    return mergeScannerReports(input)[0].length;
}
exports.countBeacons = countBeacons;
function getLargestManhattanDistance(input) {
...
exports.getLargestManhattanDistance = getLargestManhattanDistance;
//region internal
const partOne = (input) => countBeacons(input);
exports.partOne = partOne;
const partTwo = (input) => getLargestManhattanDistance(input);
